...
// Safety net: if a render exception ever unmounts the tree, this catches it
// and renders a visibly recoverable message instead of leaving a bare root
// against the app's dark background, which otherwise reads as a blank hang.
